...
class DatabaseClient {
  ...
  /**
   * Adds a score to a users score's array in the database.
   * @param {String} username - the username of the user
   * @param {Number} score - the score of the user.
   * @returns {Promise<{error: string}|{error: null}>}
   */
   ...
   * @return {Promise<Object>} - an object containing the 'scores' field which is an
  ...
  /**
   * Retrieves and returns the number of games a user has played.
   * @param username
