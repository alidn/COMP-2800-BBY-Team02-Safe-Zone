...
export default function SingleMode(props) {
  ...
  props.socket.off("want-to-start").on("want-to-start", (people) => {
    console.log(`got people who want to play: ${people}`);
    ...
    (node) => {
      if (node !== null) {
        ...
        Matter.Events.on(mouseConstraint, "mousedown", () => {
          ...
          Matter.Body.setAngle(userDot, 90);
