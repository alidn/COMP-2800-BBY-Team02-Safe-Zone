...
export function createDot(radius, color, sprite) {
...
export function addBorder(dot, borderRadius) {
  let borderDot = createDot(borderRadius || sizes.BORDER_RADIUS, colors.BORDER);
